 ...
 *
 * Set against the label width rather than the node radius. Eight stages have to
 ...
 *
 * Raised from the bundled default of 360, which was calibrated for seven
 * shorter names. This pipeline has eight stages and wider ones ("Extraction &
 * Matching", "Document Assembly"), and at 360 the first two and the middle two
 * pairs collided on screen. Because z is deliberately left free, two stages can
 * also sit at very different depths and foreshorten toward each other, so the
 * spacing has to survive that as well as the flat case.
 */
const FLOW_SPACING = 470;
